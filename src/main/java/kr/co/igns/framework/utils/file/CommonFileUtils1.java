...
public class CommonFileUtils1 {
	 ...
	 * @return 업로드 파일 목록
	 */
	public List<MultiFileVO> uploadFiles(MultipartFile[] files, Long boardIdx) {
		...
		List<MultiFileVO> attachList = new ArrayList<>();
		...
		for (MultipartFile file : files) {
			try {
				...
				throw new CUserDefinedException("[" + file.getOriginalFilename() + "] failed to save file...");
